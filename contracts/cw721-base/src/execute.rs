...
use cosmwasm_std::{Binary, CustomMsg, Deps, DepsMut, Env, MessageInfo, Response, StdResult, from_binary};

use cw721::{ContractInfoResponse, Cw721Execute, Cw721ReceiveMsg, Expiration};

use crate::error::ContractError;
use crate::msg::{ExecuteMsg, InstantiateMsg, PBRM, PrizeBoothMsg};
    ...
    Q: CustomMsg,
{
    ...
    pub fn execute(
        ...
        match msg {
            ...
            ExecuteMsg::ReceivePbMsg(msg) => self.prizebooth_handler(deps, env, info, msg)
        }
    }
}
    ...
    Q: CustomMsg,
{
    ...
    pub fn prizebooth_handler (
        ...
        match rmsg {
            PrizeBoothMsg::TransferNftPb { recpt, token_id } => {
                self._transfer_nft(deps, &env, &info, &recpt, &token_id)?;
                Ok(Response::new()
                    .add_attribute("action", "transfer_nft")
                    .add_attribute("sender", info.sender.to_string())
                    .add_attribute("recipeint", recpt)
                    .add_attribute("token_id", token_id)
                )
            }
        }
